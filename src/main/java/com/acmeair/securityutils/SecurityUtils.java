...
public class SecurityUtils {
  ...
  /**
  / Build signature with all the junk.
   */
  ...
  /* Verify signature.
   */
  public boolean verifyFullSignature(String method, String baseUri, String userId, 
      String dateString, String sigBody, String signature) {
    try {
